...
const service = {
  ...
  getCoursesOfStudent(onSuccess) {
    this.callGetRestApi('/eregister-service/course/get-courses-of-student', onSuccess)
  },
  ...
  cancelCourse(courseId, onSuccess, onError) {
    this.callRestApi('DELETE', "/eregister-service/course/cancel/" + courseId, '', onSuccess, onError, { 'Authorization': localStorage.token })
  },
